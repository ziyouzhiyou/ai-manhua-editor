...
| 阶段      | 功能                   | 技术                        |
| ------- | -------------------- | ------------------------- |
| 1. 剧本解析 | 智能提取角色、场景、对话         | MiMo V2.5 Reasoning       |
| 2. 分镜生成 | 自动生成带镜头语言的Storyboard | MiMo LLM                  |
| 3. 图像生成 | 批量生成动漫/国漫风格画面        | MiMo Image/Stability AI   |
| 4. 语音合成 | 多角色情感语音，支持中文         | MiMo TTS/Azure/ElevenLabs |
...
│   ├── agents/        # 7个专业AI代理
│   ├── skills/        # MiMo/Stability/Azure API封装
...
└── docs/              # 完整架构文档与部署指南
系统已配置好 MiMo API 的 OpenAI-compatible 接口，申请通过Token后只需在 .env 中填入 MIMO_API_KEY 即可运行。
